...
(** [get_rsc_amt st rsc] gives the amount of the resource type [rsc] stored in [st]. *)
val get_rsc_amt : GameData.resource_type -> t -> int

(** [building_consumption_gen st b] updates the state with the resources 
    consumed and generated by [b] *)
val building_consumption_gen : building -> t -> t

(** [building_active_gen st b] updates the state with the resources actively
    generated by [b] *)
...
(* [con__gen_rsc_amt b st] gives a (resource * resource) list of the
...
(** [meets_placement_reqs bt coor st] gives whether the tile at or next to [coor] 
    meets the placement requirements of building type [bt] *)
