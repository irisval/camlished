...
(** [can_place_building_at building_type coor st] gives whether a building of 
    type [building_type] can be placed on [coordinates]. *)
val can_place_building_at : GameData.building_type -> coordinates  -> t -> bool

(** [can_place_building building_type st] gives whether a there are sufficient
    resources to place a building of type [building_type]. *)
val can_place_building : GameData.building_type -> t -> bool
